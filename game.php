        ...
        <section class="features-icons text-center">
            <div class="container">
                <div class="row">
                  <div class="col-lg-4">
                    <?php
        						$message = "Угадайте число в диапазоне  от 0 до 10!"; //Устанавливаем сообщение по-умолчанию
